...
#            x_car = 2*l_car
        ...
        traffic = traff.update(traffic, x_car, y_car, orientation_car, v_car, AV_flag, Final_x, Final_y, Final_orientation)        
        initial_state = np.block ([[traffic.x], [traffic.y], [traffic.orientation],
                               [traffic.v_car],[traffic.AV_flag],[traffic.Final_x],[traffic.Final_y],[traffic.Final_orientation]])
